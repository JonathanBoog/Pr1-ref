# Cred to https://codereview.stackexchange.com/a/82121
CARD = """\
┌─────────┐
│{}       │
│         │
...
if __name__ == "__main__":
    ...
    print(
        ascii_version_of_hidden_card(test_card_1, test_card_2, test_card_3, test_card_4)
    )
    # print(ascii_version_of_hidden_card(test_card_1, test_card_2))
    print(test_card_2.points)
